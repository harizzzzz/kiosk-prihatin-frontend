import { Box, Flex, Heading, Text, FormControl, FormLabel, Input, Button, Grid, GridItem,ChakraProvider,Radio,RadioGroup,Stack } from '@chakra-ui/react';
...
Donating to Kiosk Prhatin is a direct investment in community empowerment and accessibility. Your contribution fuels easily accessible hubs that provide essential resources, education, and support, fostering self-sufficiency and resilience within communities. By supporting Kiosk Prhatin, you're not just giving aid; you're catalyzing social change, promoting inclusivity, and ensuring that every donation makes a lasting impact towards creating a more equitable and supportive society.        </Text>
  ...
  <GridItem colSpan={2}>
    <FormControl id="cardNumber" mb="4">
      ...
      <Input type="text" placeholder="Enter references" />
    </FormControl>
  </GridItem>
</Grid>
  ...
  <Button
    ...
    display="block" // Change the display to block for full width
    colorScheme="green"
    size="lg"
    px={8}
    py={4}
